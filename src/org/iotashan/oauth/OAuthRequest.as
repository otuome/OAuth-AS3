package org.iotashan.oauth
{
	 ...
	 * This is the class you will use to 
	 * generate and sign your OAuth requests.
	...
	public class OAuthRequest
	{
		 ...
		 * Value MUST be uppercase, for example:
		 * HEAD, GET , POST, etc.
		 */
		...
		/**
		 * The requestURL MUST include the scheme, authority, 
		 * and path, and MUST exclude the query string.
		 */
		...
		/**
		 * The requestParams object must be a simple object 
		 * with name value pairs, with the value being
		 * able to be converted to a string. Example: 
		 * { title: "My Book title", pageCount: 10, inLibrary: true }
		 */
		 ...
		 * @param token
		 */		
		public function OAuthRequest( httpMethod:String, 
									  requestURL:String, 
									  requestParams:Object=null, 
									  consumer:OAuthConsumer=null, 
		 ...
		 */
		public function buildRequest( signatureMethod:IOAuthSignatureMethod, 
									  resultType:String=RESULT_TYPE_URL_STRING, 
									  headerRealm:String="" ):* 
		{
		...
		///////////////////////////////////////////////////////////////////////////////////////////////
		/**
		 * Returns a string that consists of all 
		...
		/**
		 * Returns a string that consists of all the 
